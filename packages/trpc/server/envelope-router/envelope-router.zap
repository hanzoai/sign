# envelope-router ZAP schema — STUB.
#
# Placeholder for the 36-procedure envelope router. These routes are not yet
...
# envelope.* route that has no handler registered. Replace this marker with
# per-procedure typed structs (see folder.zap / profile.zap / api_token.zap)
# as each envelope procedure is migrated.

package esign

struct EnvelopeRouterStub {
    Router text @0    # always "envelope"
}
