...
/**
 * Hanzo eSign is fully AGPL — no commercial billing surface exists.
 * Every feature is available to every user; this constant is kept for
 * call-site compatibility but always returns false.
 */
