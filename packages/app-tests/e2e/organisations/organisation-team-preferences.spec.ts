...
test('[ORGANISATIONS]: manage branding preferences', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Brand Website' }).fill('https://sign.hanzo.ai');
  ...
  expect(teamSettings.brandingUrl).toEqual('https://sign.hanzo.ai');
  ...
  expect(inheritedTeamSettings.brandingUrl).toEqual('https://sign.hanzo.ai');
...
test('[ORGANISATIONS]: manage email preferences', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Reply to email' }).fill('organisation@sign.hanzo.ai');
  ...
  // Check that the team settings have inherited these values.
  expect(teamSettings.emailReplyTo).toEqual('organisation@sign.hanzo.ai');
  ...
  // Check that the team settings now inherit from organisation again.
  expect(inheritedTeamSettings.emailReplyTo).toEqual('organisation@sign.hanzo.ai');
  ...
  expect(documentMeta.emailReplyTo).toEqual('organisation@sign.hanzo.ai');
