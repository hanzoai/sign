...
test('[ORGANISATIONS]: manage branding preferences', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Brand Website' }).fill('https://esign.hanzo.ai');
  ...
  expect(teamSettings.brandingUrl).toEqual('https://esign.hanzo.ai');
  ...
  expect(inheritedTeamSettings.brandingUrl).toEqual('https://esign.hanzo.ai');
...
test('[ORGANISATIONS]: manage email preferences', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Reply to email' }).fill('organisation@esign.hanzo.ai');
  ...
  // Check that the team settings have inherited these values.
  expect(teamSettings.emailReplyTo).toEqual('organisation@esign.hanzo.ai');
  ...
  // Check that the team settings now inherit from organisation again.
  expect(inheritedTeamSettings.emailReplyTo).toEqual('organisation@esign.hanzo.ai');
  ...
  expect(documentMeta.emailReplyTo).toEqual('organisation@esign.hanzo.ai');
