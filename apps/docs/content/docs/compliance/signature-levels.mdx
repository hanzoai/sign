...
<Callout type="warn">
  Status: [Planned](https://github.com/hanzo-sign/backlog/issues/9) via third party until [Let's
  Sign](https://github.com/hanzo-sign/backlog/issues/21) is realized.
</Callout>
...
<Callout type="warn">
  Status: [Planned](https://github.com/hanzo-sign/backlog/issues/32) via third party until [Let's
  Sign](https://github.com/hanzo-sign/backlog/issues/21) is realized.
</Callout>
...
<Callout type="warn">Status: [Planned](https://github.com/hanzo-sign/backlog/issues/34)</Callout>
