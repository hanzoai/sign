...
```bash
# List all documents
curl -X GET "https://app.esign.hanzo.ai/v1/rpc/envelope" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx"

# Filter by status and paginate

curl -X GET "https://app.esign.hanzo.ai/v1/rpc/envelope?status=PENDING&page=1&perPage=20" \
 -H "Authorization: api_xxxxxxxxxxxxxxxx"

# List only documents (not templates)

curl -X GET "https://app.esign.hanzo.ai/v1/rpc/envelope?type=DOCUMENT" \
 -H "Authorization: api_xxxxxxxxxxxxxxxx"
...
const BASE_URL = 'https://app.esign.hanzo.ai/v1/rpc';
...
<Tab value="curl">
```bash
curl -X GET "https://app.esign.hanzo.ai/v1/rpc/envelope/envelope_abc123" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx"
```
</Tab>
<Tab value="TypeScript">
...
const response = await fetch(`https://app.esign.hanzo.ai/v1/rpc/envelope/${envelopeId}`, {
  method: 'GET',
  headers: {
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/create" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
...
const response = await fetch('https://app.esign.hanzo.ai/v1/rpc/envelope/create', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
  },
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/update" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.esign.hanzo.ai/v1/rpc/envelope/update', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
...
```bash
# Basic send
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/distribute" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "envelopeId": "envelope_abc123"
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.esign.hanzo.ai/v1/rpc/envelope/distribute', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/delete" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "envelopeId": "envelope_abc123"
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.esign.hanzo.ai/v1/rpc/envelope/delete', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/get-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.esign.hanzo.ai/v1/rpc/envelope/get-many', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
...
async function getAllPendingDocuments() {
  ...
  while (hasMore) {
    const response = await fetch(
      `https://app.esign.hanzo.ai/v1/rpc/envelope?status=PENDING&page=${page}&perPage=100`,
      {
