...
curl -X GET "https://app.esign.hanzo.ai/v1/rpc/template?type=PRIVATE&page=1&perPage=20" \
 -H "Authorization: api_xxxxxxxxxxxxxxxx"
...
<Tab value="curl">
```bash
curl -X GET "https://app.esign.hanzo.ai/v1/rpc/template/123" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx"
```
</Tab>
<Tab value="TypeScript">
...
const response = await fetch(`https://app.esign.hanzo.ai/v1/rpc/template/${templateId}`, {
  method: 'GET',
  headers: {
...
```bash
# Create document from template
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/template/use" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/template/update" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "templateId": 123,
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/template/duplicate" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "templateId": 123
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/template/delete" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "templateId": 123
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/template/direct/create" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "templateId": 123,
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/template/direct/toggle" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "templateId": 123,
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/template/direct/delete" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "templateId": 123
