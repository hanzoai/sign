...
```
GET /v1/rpc/envelope/recipient/{recipientId}
```
...
<Tab value="curl">
```bash
curl "https://app.esign.hanzo.ai/v1/rpc/envelope/recipient/789" \
...
const response = await fetch(
  'https://app.esign.hanzo.ai/v1/rpc/envelope/recipient/789',
  {
    headers: {
...
POST /v1/rpc/envelope/recipient/create-many
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/recipient/create-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
...
```typescript
const response = await fetch(
  'https://app.esign.hanzo.ai/v1/rpc/envelope/recipient/create-many',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
```
POST /v1/rpc/envelope/recipient/update-many
```
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/recipient/update-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "envelopeId": "clu1abc2def3ghi4jkl",
...
```typescript
const response = await fetch(
  'https://app.esign.hanzo.ai/v1/rpc/envelope/recipient/update-many',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
POST /v1/rpc/envelope/recipient/delete
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/recipient/delete" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "recipientId": 789
...
```typescript
const response = await fetch(
  'https://app.esign.hanzo.ai/v1/rpc/envelope/recipient/delete',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
```typescript
const response = await fetch('https://app.esign.hanzo.ai/v1/rpc/envelope/recipient/create-many', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
