...
<Tab value="curl">
```bash
curl -X GET "https://app.esign.hanzo.ai/v1/rpc/envelope/field/456" \
...
const response = await fetch(
  'https://app.esign.hanzo.ai/v1/rpc/envelope/field/456',
  {
    method: 'GET',
    headers: {
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/field/create-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
...
```typescript
const response = await fetch(
  'https://app.esign.hanzo.ai/v1/rpc/envelope/field/create-many',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/field/update-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "documentId": 123,
...
```typescript
const response = await fetch(
  'https://app.esign.hanzo.ai/v1/rpc/envelope/field/update-many',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/field/delete" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "fieldId": 456
...
```typescript
const response = await fetch(
  'https://app.esign.hanzo.ai/v1/rpc/envelope/field/delete',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
async function addSignatureBlock(documentId: number, recipientId: number) {
  ...
  const response = await fetch('https://app.esign.hanzo.ai/v1/rpc/envelope/field/create-many', {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
      'Content-Type': 'application/json',
