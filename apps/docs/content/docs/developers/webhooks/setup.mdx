...
func main() {
	http.HandleFunc("/webhooks/hanzo-sign", webhookHandler)
...
<Accordions type="multiple">
  ...
  <Accordion title="Verify signatures">
    Use a webhook secret and verify the `X-Hanzo-Secret` header (see [Verification](/docs/developers/webhooks/verification)).
  </Accordion>
