...
<Tab value="curl">
```bash
curl -X POST "https://app.esign.hanzo.ai/v1/rpc/envelope/envelope_abc123/distribute" \
  -H "Authorization: YOUR_API_TOKEN" \
...
const response = await fetch(
  `https://app.esign.hanzo.ai/v1/rpc/envelope/${envelopeId}/distribute`,
  {
    method: 'POST',
    headers: {
      Authorization: 'YOUR_API_TOKEN',
...
BASE_URL="https://app.esign.hanzo.ai/v1/rpc"
...
- [TypeScript SDK](https://github.com/hanzo-sign/sdk-typescript)
- [Python SDK](https://github.com/hanzo-sign/sdk-python)
- [Go SDK](https://github.com/hanzo-sign/sdk-go)
