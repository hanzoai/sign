...
![User dropdown menu](/public-api-images/hanzo-sign-user-dropdown-menu.webp)
...
![API tokens page](/public-api-images/api-tokens-page-hanzo-sign.webp)
...
![API key display](/public-api-images/hanzo-sign-api-key-blurred.webp)
...
```bash
curl https://app.esign.hanzo.ai/v1/rpc/documents \
...
```typescript
const response = await fetch('https://app.esign.hanzo.ai/v1/rpc/documents', {
  method: 'GET',
  headers: {
...
```typescript
import { Hanzo Sign } from '@hanzo/esign-sdk-typescript';
...
SDKs are available for [TypeScript](https://github.com/hanzo-sign/sdk-typescript), [Python](https://github.com/hanzo-sign/sdk-python), and [Go](https://github.com/hanzo-sign/sdk-go).

## API Base URLs

| Environment | Base URL                               |
| ----------- | -------------------------------------- |
| Production  | `https://app.esign.hanzo.ai/v1/rpc`     |
| Staging     | `https://stg-app.esign.hanzo.ai/v1/rpc` |
| Self-hosted | `https://your-domain.com/v1/rpc`       |
...
<Callout type="info">
  ...
  OpenAPI reference](https://app.esign.hanzo.ai/v1/rest/openapi).
</Callout>
...
SIGN_API_KEY=api_xxxxxxxxxxxxxxxx
```
