---
title: Email Domains
description: Learn how to create and manage email domains in Hanzo eSign.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default Hanzo eSign email address.
...
- Access to your Hanzo eSign organisation as an admin or manager
...
After adding your domain, Hanzo eSign will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the Hanzo eSign email domains settings page and click the "Verify" button.
