---
title: Email Domains
description: Learn how to create and manage email domains in Hanzo Sign.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default Hanzo Sign email address.
...
- Access to your Hanzo Sign organisation as an admin or manager
...
After adding your domain, Hanzo Sign will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the Hanzo Sign email domains settings page and click the "Verify" button.
