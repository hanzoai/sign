---
title: Overview
description: Organisations are the top-level entity in Hanzo eSign, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in Hanzo eSign's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in Hanzo eSign dashboard](/organisations/organisations-create.webp)
