...
<Steps>
  ...
  <Step>
    ...
    ![Dialog to enable two-factor authentication with QR code setup](/get-started-images/hanzo-sign-enable-2-factor-authentication.webp)
  ...
  <Step>
    ...
    ![Passkeys settings page showing registered passkeys](/get-started-images/hanzo-sign-passkeys-page.webp)
  ...
  <Step>
    ...
    ![Dialog to add a new passkey with name input field](/get-started-images/hanzo-sign-add-passkey-box.webp)
