---
title: Railway
description: Deploy Hanzo Sign on Railway with automatic builds from Git, a persistent volume for the embedded SQLite database, and built-in networking. Use the one-click template or manual setup.
---
...
- Fork or select the [Hanzo Sign repository](https://github.com/hanzoai/esign)
...
- Select your Hanzo Sign service
...
In the Railway dashboard, select your Hanzo Sign service and open a shell (or use
