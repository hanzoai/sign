...
stringData:
  ...
  NEXT_PRIVATE_DIRECT_DATABASE_URL: 'postgresql://user:password@postgres-host:5432/hanzo-sign'
...
NEXT_PRIVATE_DIRECT_DATABASE_URL: 'postgresql://hanzo-sign:your-secure-password@postgres.hanzo-sign.svc.cluster.local:5432/hanzo-sign'
```
...
<Accordions type="multiple">
  ...
  <Accordion title="Database connection errors">
    ...
    ```bash
    kubectl run postgres-test --rm -it --image=postgres:15-alpine -n hanzo-sign -- psql "postgresql://user:password@host:5432/database" -c "SELECT 1"
    ```
  </Accordion>
