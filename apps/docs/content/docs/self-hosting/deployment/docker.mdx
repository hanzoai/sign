...
docker run -d \
  ...
  -e NEXT_PRIVATE_DATABASE_URL="postgresql://user:password@db-host:5432/hanzo-sign" \
...
NEXT_PRIVATE_DATABASE_URL=postgresql://user:password@db-host:5432/hanzo-sign
