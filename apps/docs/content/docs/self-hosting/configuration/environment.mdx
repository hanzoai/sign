...
# Database
NEXT_PRIVATE_DATABASE_URL="postgres://user:password@localhost:5432/hanzo-sign"
NEXT_PRIVATE_DIRECT_DATABASE_URL="postgres://user:password@localhost:5432/hanzo-sign"
