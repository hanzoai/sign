...
- **Authorized JavaScript origins**: `https://<hanzo-sign-domain>`
- **Authorized redirect URIs**: `https://<hanzo-sign-domain>/api/auth/callback/google`
...
```bash
https://<hanzo-sign-domain>/api/auth/callback/microsoft
```
