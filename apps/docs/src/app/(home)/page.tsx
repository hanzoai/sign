...
export const metadata: Metadata = {
  title: 'Hanzo eSign Docs',
  description:
    'The official documentation for Hanzo eSign, the open-source document signing platform. Send documents for signatures, integrate with the API, or self-host with full control.',
};
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mb-16 pt-6 text-center">
        <h1 className="mb-4 text-4xl font-bold tracking-tight">Hanzo eSign Documentation</h1>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <a
            href="https://github.com/hanzoai/esign"
      ...
      <div className="from-fd-primary/5 to-fd-primary/10 rounded-xl border bg-gradient-to-r p-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <a
            href="https://esign.hanzo.ai/discord"
            className="bg-fd-background hover:bg-fd-accent inline-flex items-center gap-2 rounded-lg border px-4 py-2 text-sm font-medium transition-colors"
          >
          ...
          <a
            href="https://app.esign.hanzo.ai/signup"
