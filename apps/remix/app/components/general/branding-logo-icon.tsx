...
// The Hanzo house mark on its own, mono via currentColor — the compact icon
// form of the wordmark for tight surfaces (the mobile header, embed strips).
export const BrandingLogoIcon = ({ ...props }: LogoProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 67 67" aria-label="Hanzo" {...props}>
