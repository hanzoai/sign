...
import type { TDeleteTemplateMutationSchema } from '@hanzo/esign-trpc/server/template-router/schema';
...
export const TemplateDeleteDialog = ({
  ...
  const { mutateAsync: deleteTemplate, isPending } = useZapMutation<
    unknown,
    TDeleteTemplateMutationSchema
